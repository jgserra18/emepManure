# Test script for the MMS package
# This script tests the MMS class using the functions from the appropriate script files
...
# Test with slurry crust = FALSE to demonstrate the effect
